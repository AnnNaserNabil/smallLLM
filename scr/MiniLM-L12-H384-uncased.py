...
def main():
    ...
    model = AutoModelForSequenceClassification.from_pretrained(CONFIG['model']['model_name'], num_labels=CONFIG['model']['num_labels']).to(device)
    ...
    save_metrics("MiniLM", filtered_results, CONFIG)
